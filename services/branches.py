...
from i18n import DEFAULT_LANGUAGE, localize_city, t
    ...
    "almaty": {
        ...
        "branches": {
            "zeleny_bazar": {
                ...
                "map_url": "https://go.2gis.com/TEd8X",
            ...
            "grand_park": {
                ...
                "map_url": "https://go.2gis.com/X3Wu1",
            ...
            "mega_park": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/XnBXz",
            ...
            "forum": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/r8NtQ",
            ...
            "aport1": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/j3iyI",
            ...
            "aport2": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/hVcXF",
                "manager_phone": "8-705-867-06-92",
            },
            "almaty_mall": {
                "name": "Almaty Mall",
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/oosGK",
                "manager_phone": "8-700-333-22-23",
            },
            "sputnik": {
                "name": "Спутник",
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/1vjai",
                "manager_phone": "8-700-333-22-23",
            },
            "ritz_palace": {
                "name": "Ритц палас",
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/6ACao",
                "manager_phone": "8-700-333-22-23",
            },
        },
    },
    "astana": {
        ...
        "branches": {
            "saryarka": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/OFG2x",
            ...
            "khan_shatyr": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/i6oMW",
            ...
            "asia_park": {
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/eRMIq",
                "manager_phone": "",
            },
            "eurasia": {
                "name": "Евразия",
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/x5Zne",
                "manager_phone": "8-707-895-88-86",
            },
            "aruzhan": {
                "name": "Аружан",
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/uvJKr",
                "manager_phone": "8-700-333-22-23",
            },
            "abu_dhabi": {
                "name": "Абу даби",
                ...
                "schedule": "10:00 до 22:00",
                "map_url": "https://go.2gis.com/a0ZLB",
                "manager_phone": "8-700-333-22-23",
            },
        },
    },
    "aktobe": {
        ...
        "branches": {
            "aktobe_ecash": {
                ...
                "map_url": "https://2gis.kz/aktobe/search/Ecash%20%D0%90%D0%BA%D1%82%D0%BE%D0%B1%D0%B5/firm/70000001113875247/57.142762%2C50.285115?m=57.142792%2C50.285098%2F17.42",
...
def get_branch_display(branch_id: str | None, lang: str = DEFAULT_LANGUAGE) -> str:
    branch = get_branch_info(branch_id)
    if not branch:
        return t("not_selected", lang)
    city_name = ""
    for city_id, city_data in load_branches().items():
        if branch_id in city_data.get("branches", {}):
            city_name = localize_city(city_id, city_data.get("name", city_id), lang)
            break
    if city_name and branch.get("name"):
        return f"{city_name} · {branch['name']}"
    return branch.get("name") or t("not_selected", lang)
...
def get_city_name(city_id: str | None, lang: str = DEFAULT_LANGUAGE) -> str | None:
    if not city_id:
        return None
    data = load_branches()
    city_info = data.get(city_id)
    return localize_city(city_id, city_info.get("name", city_id), lang) if city_info else None
